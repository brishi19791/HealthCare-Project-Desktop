...
public class OrganizationDirectory {
    ...
    public Organization createOrganization(Organization.Type type){
        ...
        else if (type.getValue().equals(Organization.Type.Recepionist.getValue())){
            organization = new ReceptionOrganization();
            organizationList.add(organization);
        }
        else if (type.getValue().equals(Organization.Type.DrugDistributor.getValue())){
            organization = new DrugDistributionOrganization();
            organizationList.add(organization);
        }
        ...
        else if (type.getValue().equals(Organization.Type.QualityAnalyst.getValue())){
            organization = new QualityAnalystOrganization();
            organizationList.add(organization);
        }
