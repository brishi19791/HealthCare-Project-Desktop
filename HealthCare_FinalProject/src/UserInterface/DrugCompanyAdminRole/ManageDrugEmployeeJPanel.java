 ...
 * @author user
 */
public class ManageDrugEmployeeJPanel extends javax.swing.JPanel {
    ...
    public ManageDrugEmployeeJPanel(JPanel userProcessContainer,OrganizationDirectory organizationDir) {
        initComponents();
