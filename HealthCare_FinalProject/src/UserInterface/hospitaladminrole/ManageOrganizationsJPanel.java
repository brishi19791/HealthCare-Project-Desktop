...
public class ManageOrganizationsJPanel extends javax.swing.JPanel {
    ...
    public ManageOrganizationsJPanel(JPanel userProcessContainer,OrganizationDirectory organizationDirectory) {
        initComponents();
     ...
     private void populateCombo(){
        ...
        for (Type type : Organization.Type.values()){
            if (type.getValue().equals(Type.Doctor.getValue())||type.getValue().equals(Type.Nurse.getValue())||type.getValue().equals(Type.Lab.getValue())||type.getValue().equals(Type.Patient.getValue()))
